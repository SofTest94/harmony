    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                {
                    name: treatments_schema_1.Treatments.name,
                    schema: treatments_schema_1.TreatmentSchema,
                },
            ]),
        ],
        controllers: [treatments_controller_1.TreatmentsController],
        providers: [treatments_service_1.TreatmentService],
        exports: [treatments_service_1.TreatmentService],
    })
], TreatmentsModule);
